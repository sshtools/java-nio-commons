...
public class BoxFileSystemProviderTest extends AbstractRemoteSetup {
    ...
    void testShouldCreateDirectory() {
        ...
        var path = provider.getPath(toURI("box:///test_box/test_create"));
    ...
    void testShouldThrowExceptionIfDirectoryToCreateAlreadyExists() {
        ...
        var path = provider.getPath(toURI("box:///test_box/test_create_exists"));
    ...
    void testShouldThrowExceptionIfParentDirectoryDoesNotExistsOnCreate() {
        ...
        var path = provider.getPath(toURI("box:///test_box/parent_not_present/test_create_exists"));
    ...
    void testShouldDeleteDirectory() {
        ...
        var path = provider.getPath(toURI("box:///test_box/test_delete"));
    ...
    void testShouldThrowExceptionDeleteDirectoryNotPresent() {
        ...
        var path = provider.getPath(toURI("box:///test_box/test_delete_does_not_exists"));
    ...
    void testDeleteFile() throws IOException {
        ...
        var fileToDeletePath = provider.getPath(toURI("box:///test_box/test_delete/file_to_copy.txt"));
    ...
    void testShouldThrowExceptionIfDeleteFileDoesNotExists() {
        ...
        var fileToDeletePath = provider.getPath(toURI("box:///test_box/test_delete_does_not_exists.txt"));
    ...
    void testShouldCopyFileFromOneDirectoryToAnother() throws IOException {
        ...
        var sourceDirectory = provider.getPath(toURI("box:///test_box/copy_source"));
        var destinationDirectory = provider.getPath(toURI("box:///test_box/copy_destination"));
        ...
        var destinationFile = provider.getPath(toURI("box:///test_box/copy_destination/file_to_copy.txt"));
    ...
    void testShouldThrowExceptionIfSourceIsNotPresentCopyFileFromOneDirectoryToAnother() {
        ...
        var sourceFile = provider.getPath(toURI("box:///test_box/copy_source_file_does_not_exists.txt"));
        var destinationDirectory = provider.getPath(toURI("box:///test_box/copy_destination_exception"));
    ...
    void testShouldThrowExceptionIfDestinationIsNotPresentCopyFileFromOneDirectoryToAnother() throws IOException {
        ...
        var sourceDirectory = provider.getPath(toURI("box:///test_box/copy_source_destination_missing"));
        ...
        var sourceFile = provider.getPath(toURI(sourcePath));
        var destinationFile = provider.getPath(toURI("box:///test_box/copy_destination_not_present/file_to_copy.txt"));
    ...
    void testShouldMoveFileFromOneDirectoryToAnother() throws IOException {
        ...
        var sourceDirectory = provider.getPath(toURI("box:///test_box/move_source"));
        var destinationDirectory = provider.getPath(toURI("box:///test_box/move_destination"));
        ...
        var sourceFile = provider.getPath(toURI(sourcePath));
        var destinationFile = provider.getPath(toURI("box:///test_box/move_destination/file_to_move.txt"));
    ...
    void testShouldThrowExceptionIfSourceIsNotPresentMoveFileFromOneDirectoryToAnother() {
        ...
        var sourceFile = provider.getPath(toURI("box:///test_box/move_source_file_does_not_exists.txt"));
        var destinationDirectory = provider.getPath(toURI("box:///test_box/move_destination_exception"));

        provider.createDirectory(destinationDirectory);

        var destinationFile = provider.getPath(toURI("box:///test_box/move_destination/file_to_copy.txt"));
    ...
    void testShouldThrowExceptionIfDestinationIsNotPresentMoveFileFromOneDirectoryToAnother() throws IOException {
        ...
        var sourceDirectory = provider.getPath(toURI("box:///test_box/move_source_destination_missing"));
        ...
        var sourceFile = provider.getPath(toURI(sourcePath));
        var destinationFile = provider.getPath(toURI("box:///test_box/move_destination_not_present/file_to_copy.txt"));
    ...
    void testFileSame() throws IOException {
        ...
        var sourceDirectory = provider.getPath(toURI("box:///test_box/test_file_same"));
        ...
        var path1 = provider.getPath(toURI("box:///test_box/test_file_same/file.txt"));
        var path2 = provider.getPath(toURI("box:///test_box/test_file_same/file.txt"));
        var path3 = provider.getPath(toURI("box:///test_box/test_file_same/another_folder/../file.txt"));
        var path4 = provider.getPath(toURI("box:///test_box/test_file_same/to/another/../../file.txt"));
        var path5 = provider.getPath(toURI("box:///test_box/test_file_same/to/another/../../../file.txt"));
    ...
    void testDirectoryStreamWithNoFilter() throws IOException {
        ...
        var provider = getNewBoxFileSystemProvider();
        var directory = provider.getPath(toURI("box:///test_box/filter"));
